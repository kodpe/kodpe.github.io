...
export const piecesStartPosition = [
    ...
    { oldx: -1, oldy: -1, x: 3, y: 9, cooldown: 0, color: "white", type: "elephant" },
    { oldx: -1, oldy: -1, x: 4, y: 9, cooldown: 0, color: "white", type: "roi" },
    { oldx: -1, oldy: -1, x: 5, y: 9, cooldown: 0, color: "white", type: "reine" },
    { oldx: -1, oldy: -1, x: 6, y: 9, cooldown: 0, color: "white", type: "faucon" },
